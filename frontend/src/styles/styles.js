const styles = {
    ...
    banner_button: "bg-white cursor-pointer flex h-[50px] items-center justify-center mt-5 my-3 rounded-xl w-[150px]",
    message_button: "bg-[#000] cursor-pointer flex h-[50px] items-center justify-center mt-5 my-3 rounded-xl w-[150px]",
